...
<body>
    <div class="container-fluid" style="margin-top:10px">
        <div class="row">
            <div class="col-sm-6">
                <a style="text-decoration:none" class="ind_header" href="index.php">
                    <span style="font-size:60px; margin-left:25px; margin-top:20px">Find People of Your Intrest</span></a>
            </div>
            <div class="col-sm-3">
            </div>
            <div class="col-sm-3">
